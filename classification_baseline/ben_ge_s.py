...
class BenGeS(Dataset):
    def __init__(
        ...
        self.root_dir_worldcover = root_dir_worldcover
    ...
    def __getitem__(self, idx):
        ...
        # Worldcover
        file_name_worldcover = self.data_index.loc[:, "patch_id"][idx]
        path_image_worldcover = os.path.join(self.root_dir_worldcover, file_name_worldcover) + "_esaworldcover.npy"
        img_worldcover = np.load(path_image_worldcover)
