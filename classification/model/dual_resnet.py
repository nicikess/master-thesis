...
from classification.model.resnet import ResNet
import torch
...
class DualResNet(nn.Module):
    def __init__(self, in_channels_1, in_channels_2, number_of_classes):
        ...
        self.res_net_1 = ResNet(in_channels_1, number_of_classes)
        # Second stream of ResNet() for Sentinel 2 data (in_channels_2 = 4)
        self.res_net_2 = ResNet(in_channels_2, number_of_classes)
