...
class RemoteFilesAndDirectoryReferencesLarge:
    # Files
    ESA_WORLD_COVER_CSV_TRAIN = (
        "/ds2/remote_sensing/ben-ge/ben-ge/data-index/ben-ge-train.csv"
    )
    ESA_WORLD_COVER_CSV_VALIDATION = (
        "/ds2/remote_sensing/ben-ge/ben-ge/data-index/ben-ge-validation.csv"
    )
    ESA_WORLD_COVER_CSV_TEST = (
        "/ds2/remote_sensing/ben-ge/ben-ge/data-index/ben-ge-test.csv"
    )
