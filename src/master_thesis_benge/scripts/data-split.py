...
def make_split():
    ...
    data_path = "/netscratch2/nkesseli/master-thesis-benge/src/master_thesis_benge/scripts/data-splits"
...
def check_split_for_unique_patch_ids():
    ...
    df1 = pd.read_csv("data-splits/ben-ge-train.csv")
    df2 = pd.read_csv("data-splits/ben-ge-validation.csv")
    df3 = pd.read_csv("data-splits/ben-ge-test.csv")
...
if __name__ == "__main__":
    ...
    df_train20 = pd.read_csv("data-splits/ben-ge-train20.csv")
    df_train40 = pd.read_csv("data-splits/ben-ge-train40.csv")
    df_train60 = pd.read_csv("data-splits/ben-ge-train60.csv")
    df_train80 = pd.read_csv("data-splits/ben-ge-train80.csv")
    df_train = pd.read_csv("data-splits/ben-ge-train.csv")
    ...
    df_validation20 = pd.read_csv("data-splits/ben-ge-validation20.csv")
    df_validation40 = pd.read_csv("data-splits/ben-ge-validation40.csv")
    df_validation60 = pd.read_csv("data-splits/ben-ge-validation60.csv")
    df_validation80 = pd.read_csv("data-splits/ben-ge-validation80.csv")
    df_validation = pd.read_csv("data-splits/ben-ge-validation.csv")
    ...
    df_test20 = pd.read_csv("data-splits/ben-ge-test20.csv")
    df_test40 = pd.read_csv("data-splits/ben-ge-test40.csv")
    df_test60 = pd.read_csv("data-splits/ben-ge-test60.csv")
    df_test80 = pd.read_csv("data-splits/ben-ge-test80.csv")
    df_test = pd.read_csv("data-splits/ben-ge-test.csv")
