...
def visualize_glo_dem_30():
    ...
    filtered_values = [value for value in all_values if lower_threshold <= value <= upper_threshold]
    ...
    plt.savefig("/netscratch2/nkesseli/master-thesis-benge/src/master_thesis_benge/scripts/plot_output")
