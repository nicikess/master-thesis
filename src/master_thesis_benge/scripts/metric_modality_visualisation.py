...
if __name__ == "__main__":
    ...
    plt.plot(one_modality, one_modality_f1, marker='s', label='One modality', color='blue')
    ...
    plt.plot(two_modality, two_modality_f1, marker='v', label='Two modalities', color='blue')
    ...
    plt.plot(three_modality, three_modality_f1, marker='o', label='Three modalities', color='blue')
